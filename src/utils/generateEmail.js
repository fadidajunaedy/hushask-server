...
const emailResetPassword = async (user, resetPasswordToken) => {
  try {
    ...
    await transporter.sendMail({
      ...
      to: user.email,
      subject: `Reset Your Password - HushAsk`,
      html: `
        <p>Hi ${user.name},</p>
        <p>We received a request to reset your password for your HushAsk account. If you didn’t request this, please ignore this email.</p>
